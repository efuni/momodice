...
如果你是一名老练的DnD玩家，你可以直接从跳过**第零章**，从第一章开始了解。  
如果桃桃姬在游戏过程中出现任何故障，欢迎联系开发者QQ - 1729764254 -
...
!> 在录入时请注意输入的符号，例如空格是否为半角空格，逗号是否为英文逗号。这些都会导致录入失败。  
...
##### 法术效应  
某些法术在使用后存在法术效应，例如护盾术，加速术，会给你提供限时的AC加值等。  
