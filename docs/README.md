...
每一条项目用空格隔开,专精技能(双倍熟练加值)后加<kbd>*</kbd>,被动特质后加<kbd>+</kbd>,伤害抗性、免疫相关后加<kbd>-</kbd>。  
...
..a 斧 劣势  
**进阶伤害检定**  
你可以在命令的结尾使用@功能。如果这么做，桃桃姬会自动搜寻该成员创建的主要角色并根据该角色的抗性、免疫和易伤进行伤害调整。
此功能主要用于简化玩家计算自己受到伤害的流程，推荐DM使用。出于对怪物数据保密等因素，不推荐玩家使用。  
示例如下：  
>..a 斧 优势 无情@新人的水果  
