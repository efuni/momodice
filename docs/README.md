...
* 桃桃姬是为DND跑团的**自动化**需求而设计，她拥有强大的自动化功能，可以自主完成一系列的触发机制，并且能够承担一部分记录工作。    
...
同时，第二项如果填写0(原本为武器熟练项)，则代表豁免成功不会受伤，如果填写1，则代表豁免成功伤害减半。目前会使用人物的主要施法属性来计算DC值，在后续的版本更新中，会更新自定义DC的选项。  
> [火球术 1 DEXS 6D8<火焰>]   
